...
`;
  ...
  app.post("/api/dream-team/discuss", async (req, res) => {
    try {
      ...
      // Configure depth-based parameters
      const depthConfig = {
...
5. Be practical and actionable`;
      ...
      try {
        ...
        if (jsonMatch) {
          ...
          // Extract recommendation from last message if it looks like one
