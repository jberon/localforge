...
router.post("/enhance-prompt", llmRateLimiter, asyncHandler(async (req, res) => {
...
router.post("/fix-code", llmRateLimiter, asyncHandler(async (req, res) => {
...
router.post("/assist", llmRateLimiter, asyncHandler(async (req, res) => {
...
router.post("/test-cloud", asyncHandler(async (req, res) => {
